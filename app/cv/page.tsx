...
const experience = [
  ...
  },
  {
    ...
    text: "Identified an unmet camping and recovery need and led HOVER from product strategy through development, supply chain, and launch. Built five collections and eighteen SKUs, with approximately 30,000 pairs sold.",
    href: "/hover",
  },
  {
    role: "Founder & Creative Director",
  ...
  },
  {
    ...
    text: "Led footwear proposals, design development, and supply-chain coordination; developed an early wool athletic shoe for the Chinese market and launched two product families around work and leisure.",
  },
] as const;
    ...
    <main className="cv-page">
      ...
      <section className="cv-section cv-education">
        ...
        <div className="cv-education-list">
          <article><p>Graduate study in Design</p><h3>Stanford University</h3><span>Human-centered design · Making · Behavior · Technology</span></article>
      ...
      <section className="cv-section cv-capabilities">
        ...
        <div className="cv-capability-grid">
          <article><span>01</span><h3>Strategy</h3><p>Opportunity finding, consumer research, product and brand direction.</p></article>
